...
# Suponga que hay doce preguntas de opción multiple en un 
# examen de matemáticas. Cada pregunta tiene 5 posibles respuestas 
# y sólo una de ellas es correcta. Encuentre la posibilidad de tener 4 o menos
#respuestas y solo una de ellas es correcta.
#Encuentre la probabilidad de tener 4 o menos respuestas correstas si un 
#estudio intenta responder a caad pregunta al azar.

# Solución para que saque 4 respuestas correctas:

#Dado que sólo una de cada 5 respuestas posibles es correcta,
#la probabilidad de responder correstamente una pregunta al azar 
#es de 1/5:0.2. Podemos encontrar la probabilidad de tener 
#exactamente 4 respuestas correctas por intentos aleatorios de la siguiente
#manera:
...
#3. Probabilidad de tener 4 respuestas correctas elegidas aleatoriamente.
...
# Ejemplo de cómo realizar  un gráfivo de la distribución normal,

# Rejilla de valores del eje X 

x <- 1:80
#1. Rejilla de valores de eje x, **X=80**. Se van a utilizar el mismo
#del valor de  "X", de "n" y la probabilidad es la que va a ir cambiando, 
#en esta ocasion se ocupara las probabilidades de **0.2, 0.3 y 0.4**. 
# Además de poner la leyenda 
x <- 1:80
...
# Ejercicio de como realizar nuestro gráfico de distribución 
...
# respuestas y sólo una de 
#ellas es correcta. Encuentre la probabilidad de tener cuatro 
#o menos respuestas correctas si un estudiante intenta responder a 
...
#respuestas correctas de forma aleatoria se utiliza la función 
...
#2.- Código para realizar nuestro gráfico de la distribución binomial. 

#*NOTA 1:* Se pone la leyenda en el centro del gráfico, buscando 
#*#la manera en la que no se pierda ningún dato. 
...
#una probabilidad de 0.005 de ser defectuoso. 
...
# 6.- Código para realizar nuestro gráfico de la distribución binomial. 
# *NOTA:* La leyenda se cambia de lugar para que no se tape ningún dato
...
# *Ejemplo de cómo realizar un gráfico de distribución Poisson* 
  ...
  #Rejilla de valores del eje X, *x=0:50. Se van a utilizar 
#el mismo de valor de "x", y lambda es la que va a ir cambiando, 
#en esta ocasión se ocuparán valores de **5, 10 y 20*. Además de poner 
#la leyenda. 
...
#*Ejemplos a desarrollar:*
  ...
  #Suponga que se desea saber el número de llegadas de los estudiantes 
#de una Escuela Primaria en un lapso de 15 minutos a la entrada de la 
#escuela. Se puede suponer que la probabilidad de llegada de los 
#estudiantes es la misma que cualquiera de los dos lapsos con la misma 
#dirección siendo estas independientes a que llegue o no el estudiante. 
#El número promedio de alumnos que llegan en un lapso de 15 minutos 
#son 35. Para optimizar la llegada de los estudiantes evitando las 
#aglomeraciones se requiere saber la probabilidad de que lleguen
...
#2.- Probabilidad de que 50 alumnos lleguen en 15 minutos a la
# entrada de la escuela
...
#1.- ¿Cuál es la probabilidad de que a la escuela lleguen 34 alumnos 
  ...
  # a) Probabilidad de que 34 alumnos lleguen en 5 minutos a la 
# entrada de la escuela
...
#se encuentren 120 alumnos en 5 minutos?
  ...
  #a) Probabilidad de que 120 alumnos salgann en 5 minutos a la 
#salida de la escuela
...
#Se realiza un gráfico en el que se junten las distribuciones, 
#sin embargo se debe modificar el valor de lambda para que se pueda 
#observar bien el gráfico, pero el valor de "x" sigue igual, 
# además de que la leyenda también cambia. 
